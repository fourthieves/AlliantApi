...
When you make an API call with a low level method, an AlliantApiResponse object is returned. This object is an extension
of the Response object that is returned by the Requests libray for anyone familiar with that library.

The documentation for that object can be found here: https://docs.python-requests.org/en/master/api/#requests.Response

All properties and methods documented there are available in the AlliantApiResponse.

This extension of the requests.Response object, is further extended for certain types of call.

Below is a summary of useful properties and methods that are available

| Property/Method    | Datatype               | Explanation                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|--------------------|------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| json()             | dict                   | Returns the json-encoded content of a response, if any. <br/><br/> **Parameters**:	**kwargs – Optional arguments that json.loads takes.  <br/> **Raises**:	requests.exceptions.JSONDecodeError – If the response body does not contain valid json.                                                                                                                                                               |
